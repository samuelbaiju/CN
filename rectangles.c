...
int main() {
    ...
    while (1) {
        ...
        snprintf(reply, BUFFER_SIZE, "The perimeter of the rectangle with length %d and breadth %d is %d", len,bred, perimter);
        sendto(sockfd,reply,BUFFER_SIZE,0,(struct sockaddr*)&client_address,addr_size);
